...
# MAGIC %md
# MAGIC # AppsFlyer Audience 2
# MAGIC
# MAGIC 该 Notebook 用于上传 AppsFlyer 自定义受众数据（版本2）。
...
def upload_af_audience_2_task(ds: str):
    """
    上传 AF 受众任务主函数（版本2）
    ...
    Args:
        ds: 执行日期 (YYYY-MM-DD)
    """
    print(f"📅 Processing AF Audience 2 for {ds}")
    
    do_af_audience_process_2()
    
    print(f"✅ AF Audience 2 completed successfully")
...
try:
    upload_af_audience_2_task(ds_param)
...
if env_mode != 'staging':
    ...
    print("✅ AF Audience 2 任务执行完成，请检查上传结果。")
